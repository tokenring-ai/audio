...
core AudioProvider interface and AudioService for managing audio operations including recording, playback,
transcription, and text-to-speech synthesis. This package serves as the foundation for platform-specific audio
implementations.
...
To create a new audio provider, extend the AudioProvider class and implement all abstract methods. See
`@tokenring-ai/linux-audio` for a complete implementation example.